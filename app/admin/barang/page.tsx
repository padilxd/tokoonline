...
const BarangPage = async (prop: Props) => {
    ...
    const res = await axios.get(`${BASE_API_URL}/admin/getbarang`, {
        params: { page, quantity, search },
        headers: {
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-gray-950 via-gray-900 to-gray-800 p-6 text-white">
            ...
            <h1 className="text-3xl font-bold mb-2">Barang Page</h1>
            <p className="text-gray-400 mb-6">Kelola data barang lu di sini</p>
