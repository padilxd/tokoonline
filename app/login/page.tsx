        ...
        <div className="w-3/6 p-8 bg-white rounded shadow-md">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-4">
                    ...
                    <input className="w-full p-2 border text-black border-gray-300 rounded" type="email" id="email" name="email" onChange={e => setEmail(e.target.value)} />
                </div>
                <div className="mb-6">
                    <label className="block text-black mb-2" htmlFor="password">Password</label>
                    <input className="w-full p-2 border text-black border-gray-300 rounded" type="password" id="password" name="password" onChange={e => setPassword(e.target.value)} />
                </div>
                <div>
